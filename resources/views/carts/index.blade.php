...
<div class="container">
	...
	<table id="cart" class="table table-hover table-condensed">
		...
		<tbody>
			...
			<tr>
				...
				<td class="actions" data-th="">
					...
					<button class="btn btn-primary btn-sm remove-from-cart" data-id="{{ $id }}"><i class="fas fa-trash-alt"></i> Remove</button>
				</td>
			</tr>
			@endforeach
			@endif
		...
		<tfoot>
			<tr>
				<td>
					<a href="{{ url('public') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Lanjutkan Belanja</a>
					
				</td>
				<td colspan="2" class="text-left h4"><b>TOTAL</b></td>
				<td colspan="" class="text-center h4"><b>Rp. {{ $total }}</b></td>
				<td colspan="" class="text-left h2"><a href="{{ route('admin.orders.create') }}" class="btn btn-primary"><i class="fas fa-money-bill-wave"></i> Lanjutkan ke Pembayaran</a></td>				
			</tr>
