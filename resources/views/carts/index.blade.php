...
<div class="container">
	...
	<table id="cart" class="table table-hover table-condensed">
		...
		<tbody>
			...
			<tr>
				...
				<td class="actions" data-th="">
					...
					<button class="btn btn-danger btn-sm mt-2 remove-from-cart" data-id="{{ $id }}"><i class="fas fa-trash-alt"></i> Remove</button>
				</td>
			</tr>
			@endforeach
			@endif
		...
		<tfoot>
			<tr>
				<td>
					<a href="{{ url('public') }}" class="btn btn-warning"><i class="fas fa-store"></i> Lanjutkan Belanja</a>
					<a href="{{ route('admin.orders.create') }}" class="btn btn-success"><i class="fas fa-money-bill-wave"></i> Lanjutkan ke Pembayaran</a>
				</td>
				<td colspan="2" class="text-left h4"><b>TOTAL</b></td>
				<td colspan="" class="text-center h4"><b>Rp. {{ $total }}</b></td>
				<td colspan="" class="text-center h4"></td>
			</tr>
		</tfoot>
	</table>
</div>
